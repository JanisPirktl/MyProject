...
public class CatList
{
  ...
  public static void main( String[] args ) {
    ...
    Comparator<Cat> compareByWeight2 = (c1, c2) -> Integer.compare(c1.getWeight(), c2.getWeight()); //besser als 1.
    Comparator<Cat> compareByWeight3 = Comparator.comparingInt(Cat::getWeight);    // This is not a lambda
    ...
    System.out.println(count(cats, c -> c.getName().startsWith("X"))); //besser
    ...
    System.out.println(count(cats, c -> c.getName().endsWith("x"))); //besser
    ...
    System.out.println((count(cats, ((Predicate<Cat>) c -> c.getWeight() > 1000).and(c -> c.getWeight() < 3000))));
